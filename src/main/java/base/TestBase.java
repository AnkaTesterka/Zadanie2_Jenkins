...
public class TestBase {
    ...
    public TestBase(){
        ...
        try {
            ...
            FileInputStream file = new FileInputStream(System.getProperty("user.dir") + "/src/main/java/testdata/testdata.properties");
            testdata.load(file);
        } catch (FileNotFoundException e) {
            e.printStackTrace();
         } catch (IOException e) {
    ...
    public static void initialization(){
        ...
        switch (browser) {
            case "chrome":
               ...
               // options.setCapability(CapabilityType.PLATFORM_NAME, "WIN10");
                ...
                if (grid.equalsIgnoreCase("true")){
                    try{
                        driver = new RemoteWebDriver(new URL("http://192.168.0.206:4444/wd/hub"), options);
            ...
            case "firefox":
                ...
                if (grid.equalsIgnoreCase("true")){
                    try{
                        driver = new RemoteWebDriver(new URL("http://192.168.0.206:4444/wd/hub"), optionsff);
                    } catch(MalformedURLException e){
                        e.printStackTrace();
                    }
                }
            ...
            case "ie":
                ...
                if (grid.equalsIgnoreCase("true")){
                    try{
                        driver = new RemoteWebDriver(new URL("http://192.168.0.206:4444/wd/hub"), optionsie);
                    } catch(MalformedURLException e){
                        e.printStackTrace();
                    }
                }
