...
public class DeliveryAddressDetailsPage extends TestBase {
    ...
    public void setCountry(String countryStr){
        ...
        inputCountry.sendKeys(countryStr, Keys.ENTER);
    }


    // Metoda wykonująca pełną akcję uzupełnienia formularza adresu dostawy zwracająca stronę AddressPage
    public AddressPage fillForm(String nameStr, String lastNameStr, String countryStr, String addressStr, String postcodeStr, String cityStr){
